...
usuarios. Permite registrar un dispositivo (generando UUID y asignando
cookie HTTP-Only `dispositivo_id`), listar dispositivos, cambiar su
estado (ACTIVO/INACTIVO) y eliminarlos.
//////////////////////////////////////////////////////////
*/
...
export async function listarMisDispositivos(req, res, next) {
  try {
    const dispositivos = await dispositivosModel.obtenerDispositivosPorUsuario(req.usuario.id);
